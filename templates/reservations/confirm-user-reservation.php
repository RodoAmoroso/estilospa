...
<?php if($obj->promo): ?>
<p>Te informamos que la solicitud de reserva de turno para la experiencia: <a href="<?=ROOT.'promo/'.$obj->promo->permalink.'/'.$obj->promo->id.'-'.Permalink($obj->promo->title) ?>"><?=$obj->promo->title?></a> para el día  <?= date('d/m/Y H:i',strtotime($obj->book_date)) ?> hs., ha sido confirmada por el centro.</p>
<?php else: ?>
...
<p>Podés pagar online la experiencia mediante Mercado Pago, hasta en 12 cuotas, con todos los bancos:</p>
