...
<p>Podés solicitar una nueva solicitud de reserva haciendo <a href="<?=ROOT.'promo/'.$obj->promo->permalink.'/'.$obj->promo->id.'-'.Permalink($obj->promo->title).'#turno'?>">click aquí</a></p>
