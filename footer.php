...
<section class="newsletter">
	<!-- <div class="overprint-absolute" style="background-image:url(<?= ROOTPATH ?>assets/bg-1.jpg)" ></div> -->
...
<section class="gral-section dp-none">
	<div class="container">
		...
		<div class="row">
			...
			<?php if($_CLIENTS->get('','','0,12','',0,1)): foreach ($_CLIENTS->data() as $client): ?>
			<div class="col col-xs-12 col-sm-2">				
				<a href="<?= ROOTPATH.'centros/'.$client->permalink ?>" class="dp-block"><?= $client->name ?></a>				
			</div>
...
<section class="gral-section glossary-list">
	<div class="container">
		<h3>Servicios y Tratamientos <a href="<?= ROOTPATH.'etiquetas' ?>" class="sz-10">(ver todos)</a></h3>
		<div class="row">
			<?php 
			$_GLOSSARYGROUPS->limit = '0,6';
			$_GLOSSARYGROUPS->keywords = '';
			if($_GLOSSARYGROUPS->get()): 
				foreach ($_GLOSSARYGROUPS->data() as $group): 
			?>
			<div class="col col-xs-12 col-sm-2">
				<h4 class="fw-400"><?= $group->name ?></h4>
				<?php 
				$_GLOSSARY->idgroup = $group->id;
				$_GLOSSARY->limit = '0,10';
				$_GLOSSARY->keywords = '';
				if($_GLOSSARY->get()):
					foreach ($_GLOSSARY->data() as $glossary): 
				?>
				<a href="<?= ROOTPATH.'etiqueta/'.$glossary->id.'-'.Permalink($glossary->name) ?>" class="dp-block"><?= $glossary->name ?></a>
				<?php endforeach; endif; ?>
			</div>
			<?php endforeach; endif; ?>
		</div>
...
<section class="payment">
	<div class="container">
		...
		<div class="cards">
			<img src="<?= ROOTPATH ?>assets/visa@2x.png" alt="">
			<img src="<?= ROOTPATH ?>assets/mastercard@2x.png" alt="">
			<img src="<?= ROOTPATH ?>assets/amex@2x.png" alt="">
			<img src="<?= ROOTPATH ?>assets/banelco@2x.png" alt="">
			<img src="<?= ROOTPATH ?>assets/cabal@2x.png" alt="">
			<img src="<?= ROOTPATH ?>assets/tarjeta-naranja@2x.png" alt="">
			<img src="<?= ROOTPATH ?>assets/tarjeta-shopping@2x.png" alt="">
			<img src="<?= ROOTPATH ?>assets/mercadopago@2x.png" alt="">
		</div>
		<a href="http://qr.afip.gob.ar/?qr=Hii2ReLLuZMJV76OkTZy1A,," target="_blank" class="afip">
			<img src="<?= ROOTPATH ?>assets/dataweb.jpg" alt="">
		</a>
	</div>
</section>
...
?>
<script type="text/javascript" src="<?= ROOTPATH.'js/'.$_SECTION.'.js?id='.rand(1111,9999) ?>"></script>
<?php endif; ?>
