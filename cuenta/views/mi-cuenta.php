			...
			<div class="col-xs-12 col-sm-4">
				...
				<div class="block-box">
					...
					<div class="alert alert-success">
						<h4 class="fw-400">Comisiones de EstiloSPA: $ <?= number_format($_SALES->overall()->neto,2,',','.') ?></h4>
				...
				<div class="block-box">
					...
					<div class="box-footer">
						<small class="cl-gray-40">Calculado desde el <?= date('d/m/Y', strtotime($_USER->data()->clientadded)) ?> hasta hoy</small>
					</div>
				</div>
				...
				<div class="block-box">
					...
					<div class="box-content">
						<h3 class="fw-400">Tipo de Cuenta: <?= $_USER->data()->planname ?></h3>
						<h4>Promos disponibles: 1/<?= $_USER->data()->cantpromos ?></h4>
						<small>Comisión de venta online: <?= $_USER->data()->fee ?>%</small>
					</div>
					<div class="box-footer">
						<a href="#modal_change_plan" data-toggle="modal" class="btn btn-primary btn-sm btn-block">Deseo cambiar mi plan</a>
					</div>								
				</div>				
...
<!-- MODAL CHANGE PLAN -->
<div class="modal fade" id="modal_change_plan">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h5 class="modal-title">Cambiar Mi Plan</h5>
			</div>
			<div class="modal-body">
				<p>Si necesitas cambiar el plan actual, haz click en el botón 'Enviar' y nos contactaremos contigo a la brevedad.</p>
			</div>
			<div class="modal-footer">
				<button id="btn_change_plan" class="btn btn-primary">Enviar <i class="fa fa-paper-plane"></i></button>
			</div>
		</div>
	</div>
</div>
