...
<html>
	...
	<body style="font-family:Helvetica,sans-serif;background-color:#eee">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #5ba4c8;max-width:760px;margin:26px auto">
			<thead>
				<tr>
					<th style="background-color:#5ba4c8;text-align:left;border-bottom:2px solid #e7127c"><a href="'.ROOT.'"><img src="'.ROOT.'assets/logo-white.png" alt="" style="max-width:180px;padding:20px;"></a></th>
				</tr>
			</thead>
			<tbody>
				<tr>
