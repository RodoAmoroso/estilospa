...
<p>Te recordamos que hoy <?= date('d/m/Y',strtotime($obj->book_date)) ?> a las <?= date('H:i',strtotime($obj->book_date)) ?> hs. tenés una reserva de <?=$obj->user_name?> (<?=$obj->user_email?>) de la siguiente experiencia:</p>
