...
/*var UpFile = {
	Init:function(OBJ){		
		...
		$(OBJ.BTN).click(function(){			
			$('#loading .loading-text').html('<br /><p>Subiendo archivo(s). <br />Esta operación puede durar varios minutos dependiendo del tamaño del/los archivo(s) y de la conexión.</p><p><span class="label label-success"></span></p>');
...
$(function(){
	...
	$('#form_main_search').submit(function(e){
		...
		window.location.href=ROOT+type+'/'+Permalink(main==''?'-':main)+'/'+Permalink(location);
	});
