		...
		<form id="form_publish" class="row">
			...
			<div id="fields" class="col-xs-12 col-sm-6">
				...
				<div class="form-group">
					...
					<input id="fd_web" class="form-control" ></input>
				</div>
				...
				<div class="form-group">
					...
					<input id="fd_company" class="form-control" required></input>
				</div>
			
				<div class="form-group">
					<label for="fd_how">¿Cómo nos conociste?</label>
					<select class="form-control" id="fd_how" >
				...
				<div class="form-group">
					...
					<textarea id="fd_message" class="form-control" rows="5" ></textarea>
				</div>
