	...
	<div class="container">
		...
		<form id="form_contact" class="row">
			...
			<div class="col-xs-12 col-sm-4">
				<h3>EstiloSpa.com</h3>
				<p><i class="fa fa-whatsapp"></i> <a href="https://api.whatsapp.com/send?phone=5491158314531">11 5831-4531</a></p>
			...
			<div class="col-xs-12 col-sm-6">
				<div class="form-group">
					...
					<input name="fullname" id="fd_name" type="text" class="form-control" required></input>
				</div>
				...
				<div class="form-group">
					...
					<input name="subject" id="fd_subject" type="text" class="form-control" required></input>
				</div>
				...
				<div class="g-recaptcha" data-sitekey="6Lcyu6IZAAAAAErqyVxeKFW0N5X6wS04t6ymczLY"></div>
