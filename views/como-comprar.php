<section class="gral-section">
	<div class="container">
		<h2 class="cl-aqua-3">¿Cómo Comprar?</h2>
		...
		<div class="row">
			<div class="col-xs-8">
				...
				<ol class="number-list">
					...
					<li>También podes registrarte usando tu cuenta de Facebook o Twitter.</li>
					<li>Si es para Regalar completa los datos del agasajado, para enviarle el REGALO</li>
