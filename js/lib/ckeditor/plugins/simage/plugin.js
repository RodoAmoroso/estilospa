					...
					$.ajax({
						...
						return function(data, textStatus, jqXHR) {
							...
							if (jqXHR.status == 200) {
								...
								maxWidth = Math.min(inputWidth, 1080)
								maxHeight = Math.min(inputHeight, 720)
								...
								if (editor.config.srcSet){
									...
									imgElem = '<img src="' + url + '" class="image-editor" data-width="' + inputWidth + '" data-height="' + inputHeight + '" height="auto" width="100%">'
								}
