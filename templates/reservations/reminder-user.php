...
<p>Te recordamos que hoy <?= date('d/m/Y',strtotime($obj->book_date)) ?> a las <?= date('H:i',strtotime($obj->book_date)) ?> hs. tenés una reserva en <a href="<?=ROOT.'centros/'.$obj->permalink?>"><?=$obj->client_name?></a>:</p>
